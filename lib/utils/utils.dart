...
import 'package:vendorapp/views/pages/package_types/package_type_pricing.page.dart';
import 'package:vendorapp/views/pages/product/products.page.dart';
import 'package:vendorapp/views/pages/service/service.page.dart';

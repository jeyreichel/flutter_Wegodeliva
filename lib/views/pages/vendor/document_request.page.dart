...
import 'package:vendorapp/view_models/document_request.vm.dart';
          ...
          body: model.isBusy
              ...
              : VStack(
                  [
                    ...
                    Visibility(
                      visible: model.currentVendor!.pendingDocumentApproval,
                      child: VStack(
                        [
                          Image.asset(
                    ...
                    Visibility(
                      visible: model.currentVendor!.documentRequested,
                      child: VStack(
                        [
                          Image.asset(
                            AppImages.pendingDocument,
